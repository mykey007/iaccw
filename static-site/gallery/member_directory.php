...
$sort_query = ($sort=='name') ? "m.company_n,m.last_n" : "m.id,m.company_n";
...
if (!empty($results)){
	...
	$page_txt = "
		<div align='center'><b><span style='line-height: 25px; $back_name'>&nbsp;&nbsp;<a href='/member_directory.php?sort=name&l=a'>Sort by Name</a>&nbsp;&nbsp;</span>&nbsp|&nbsp<span style='line-height: 25px;'.$back_company.''>&nbsp;&nbsp;<a href='/member_directory.php?sort=company'>Sort by Sector/Industry</a>&nbsp;&nbsp;</span></b></div>
												 ...
												 <a href='/member_directory.php?sort=name&l=a'>A</a> - 
												 <a href='/member_directory.php?sort=name&l=b'>B</a> -
												 <a href='/member_directory.php?sort=name&l=c'>C</a> -
												 <a href='/member_directory.php?sort=name&l=d'>D</a> -
												 <a href='/member_directory.php?sort=name&l=e'>E</a> -
												 <a href='/member_directory.php?sort=name&l=f'>F</a> -
												 <a href='/member_directory.php?sort=name&l=g'>G</a> -
												 <a href='/member_directory.php?sort=name&l=h'>H</a> - 
												 <a href='/member_directory.php?sort=name&l=i'>I</a> -
												 <a href='/member_directory.php?sort=name&l=j'>J</a> -
												 <a href='/member_directory.php?sort=name&l=k'>K</a> -
												 <a href='/member_directory.php?sort=name&l=l'>L</a> -
												 <a href='/member_directory.php?sort=name&l=m'>M</a> -
												 <a href='/member_directory.php?sort=name&l=n'>N</a> -
												 <a href='/member_directory.php?sort=name&l=o'>O</a> - 
												 <a href='/member_directory.php?sort=name&l=p'>P</a> -
												 <a href='/member_directory.php?sort=name&l=q'>Q</a> -
												 <a href='/member_directory.php?sort=name&l=r'>R</a> -
												 <a href='/member_directory.php?sort=name&l=s'>S</a> -
												 <a href='/member_directory.php?sort=name&l=t'>T</a> -
												 <a href='/member_directory.php?sort=name&l=u'>U</a> -
												 <a href='/member_directory.php?sort=name&l=v'>V</a> - 
												 <a href='/member_directory.php?sort=name&l=w'>W</a> -
												 <a href='/member_directory.php?sort=name&l=x'>X</a> -
												 <a href='/member_directory.php?sort=name&l=y'>Y</a> -
												 <a href='/member_directory.php?sort=name&l=z'>Z</a>
												 </b>	
												 <br><br>
	...
	if (!$letter) {
		...
		if (!empty($results)){
			foreach($results as $arr){
				$href = '/member_directory.php?sort=company&l='.$arr['id'];
...
$output -> DisplayCenter('member_directory', 
												 ...
												 'page_txt'=>$page_txt,
												  ...
												  'menu_voice'=>array(array('url'=>'/members.php', 'menu_name'=>'Membership', 'high'=>0), 
												                ...
												                array('url'=>'/member_directory.php', 'menu_name'=>'Members Directory', 'high'=>1),
